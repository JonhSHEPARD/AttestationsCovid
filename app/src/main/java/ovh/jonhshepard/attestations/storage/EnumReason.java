...
public enum EnumReason {
    ...
    FOOD("achats", R.string.reason_food, "Déplacements pour effectuer des achats de fournitures nécessaires à l’activité " +
    ...
    SPORT("sport_animaux", R.string.reason_sport, "Déplacements brefs, dans la limite d'une heure quotidienne et dans un rayon maximal " +
    ...
    CONVOC("convocation", R.string.reason_convoc, "Convocation judiciaire ou administrative."),
